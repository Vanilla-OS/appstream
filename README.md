...
Maintainers may use generative AI tools as assistants while working on appstream. Non-trivial assisted commits disclose the tool, model, and scope of the work.
